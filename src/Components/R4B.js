...
import Housesustainable from "../styles/Pictures/Housesustainable.jpeg";
          ...
          <CardContent>
            ...
            <Typography variant="body2" className="RecommendationFullText">
              <ul>
                ...
                <li>
                  Ask about the year of construction or retrofitting. Depending
                  on where you live, there might be an energy audit for the
                  specific building.
                </li>
                <li>
                ...
                <li>
                  If your laws allow it, change your energy provider to a clean
                  or renewable one.
                </li>
                <li>
                ...
                <li>
                  Consider installing window tints. A low-cost solution when you
                  can’t retrofit the insulation of your windows.
                </li>
                <li>

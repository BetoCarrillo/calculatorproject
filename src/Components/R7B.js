          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" className="InsulationFullText">
                <ul>
                  <li>
                    Layer up and turn down the heating: Put on an extra layer or
                    a comfy sweater, wrap yourself in a nice blanket. Keep your
                    room temperature at 19 degrees Celsius / 66 Fahrenheit in
                    winter.
                  </li>
                  <li>
              ...
              <Typography variant="body2" className="InsulationFullText">
                <ul>
                  ...
                  <li>
                    They can help you regulate your home’s temperature and
              ...
              <Typography
                ...
                className="QInsulationsDiv"
              >
                Use curtains or blinds to block out direct sunlight in the
                summer and retain heat in the winter.
              </Typography>
            </CardContent>
